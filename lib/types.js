...
exports.test = function (name, start, options, callback) {
    ...
    var test = {
        ...
        incomplete: function(msg) {            
            async.nextTick(function () {
                if (options.testIncomplete) {
                    options.testIncomplete(name, msg);
                } else {
                    options.testDone(name + '\n  INCOMPLETE: ' + msg, exports.assertionList([]));
                }
                callback(null);
            });
        },
    ...
    //Add shortcut test.incomplete shortcut
    test.todo = test.incomplete;
